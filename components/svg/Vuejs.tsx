export default function Vuejs() {
    return (
        <svg className="ionicon up-on-hover" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M256 489.639L16.1803 10H86.3702L247.056 331.35L256 349.237L264.944 331.35L425.63 10H495.82L256 489.639Z" fill="url(#paint2_linearVuejs)" stroke="url(#paint3_linearVuejs)" strokeWidth="20" />
            <defs>
                <linearGradient id="paint0_linearVuejs" x1="515" y1="-2.23464e-05" x2="6.99999" y2="514" gradientUnits="userSpaceOnUse">
