export default function Php() {
    return (
        <svg className="ionicon up-on-hover" viewBox="0 0 512 270" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="path-1-inside-php-1" fill="white">
                <path d="M256 269.2C397.385 269.2 512 208.938 512 134.6C512 60.2625 397.385 0 256 0C114.615 0 0 60.2625 0 134.6C0 208.938 114.615 269.2 256 269.2Z" />
            </mask>
            <path d="M256 269.2C397.385 269.2 512 208.938 512 134.6C512 60.2625 397.385 0 256 0C114.615 0 0 60.2625 0 134.6C0 208.938 114.615 269.2 256 269.2Z" fill="url(#paint0_linearPhp)" stroke="url(#paint1_linearPhp)" strokeWidth="40" mask="url(#path-1-inside-php-1)" />
            ...
            <path d="M226.6 39.2H255.8L248.8 75H274.8C291.2 75 302.4 77.7999 308.6 83.5999C314.8 89.3999 316.6 98.5999 314.2 111.4L302 174.2H272.4L284 114.4C285.4 107.6 284.8 103 282.6 100.6C280.4 98.1999 275.4 96.8 268 96.8H244.6L229.6 174.2H200.4L226.6 39.2Z" fill="url(#paint3_linearPhp)" />
            ...
            <defs>
                ...
                <linearGradient id="paint2_linearPhp" x1="521" y1="1.00002" x2="-6.99993" y2="261" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white" />
                    <stop offset="1" stopColor="#666666" />
                </linearGradient>
                <linearGradient id="paint3_linearPhp" x1="505" y1="10.9999" x2="-8.99999" y2="257" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white" />
                    <stop offset="1" stopColor="#666666" />
                </linearGradient>
                <linearGradient id="paint4_linearPhp" x1="507" y1="-8.99997" x2="-9" y2="261" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white" />
                    <stop offset="1" stopColor="#666666" />
                </linearGradient>
            </defs>
